 ...
 *     </li>
 *     <li>GET /api/users/:uid/followed to retrieve all users that following a user
 *     </li>
 ...
 *     a user
 *     </li>
 *     <li>DELETE /api/users/:uid/followed/:uid1 to record that a user makes a user no longer
 *     follow them
 *     </li>
 * </ul>
...
export default class FollowController implements FollowControllerI {
    ...
    public static getInstance = (app: Express): FollowController => {
        if (FollowController.followController === null) {
            ...
            app.get("/api/users/:uid/followed", FollowController.followController.findAllUsersThatFollowingUser);
            app.post("/api/users/:uid/follows/:uid1", FollowController.followController.userFollowsUser);
            app.delete("/api/users/:uid/unfollows/:uid1", FollowController.followController.userUnfollowsUser);
            app.delete("/api/users/:uid/followed/:uid1", FollowController.followController.userRemoveFollower);
        }
    ...
    /**
     * Records that a user makes a user no longer follow them from the database
     * @param {Request} req Represents request from client, including the path
     * parameter tid representing the liked tuit
     * @param {Response} res Represents response to client, including the
     * body formatted as JSON arrays containing the user objects
    ...
    userRemoveFollower = (req: Request, res: Response) =>
        FollowController.followDao.userRemoveFollower(req.params.uid, req.params.uid1)
